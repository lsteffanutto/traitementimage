...
A=imread('images/introtraitementimage/bdx.jpg'); %charger une image vrai couleur
...
[B,palette] =imread('images/introtraitementimage/lena.bmp'); %charger une image couleur indexée (palette mémorisé dans fichier = seconde variable)
%image lena 8bits non signés 

C=zeros(512); %Par defaut, valeur max, format double 64bits => pblm de class = pblm format

E =imread('images/introtraitementimage/radio.jpg'); 
F = double(imread('images/introtraitementimage/radio.jpg')); 
